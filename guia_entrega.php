    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<a href="nueva_entrega.php"  class="btn btn-info">
                    <span class="glyphicon glyphicon-plus" ></span> Nueva Guía
                </a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Guía Entrega</h4>
		</div>	
...
<script type="text/javascript" src="js/guia_entrega.js"></script>
</body>
</html>