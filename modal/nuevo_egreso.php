...
?>
<!-- Modal -->
<div class="modal fade" id="nuevoEgreso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="guardar_egreso" name="guardar_egreso">
                    ...
                    <div class="form-group producto">
                        ...
                        <div class="form-group">
                            <label for="fecha_egreso" class="col-sm-3 control-label" style="text-align:left; margin-left:15px;">Fecha</label>
                            <div class="col-sm-8">
                                <input style="width: 95%; margin-left: -8px;"  type="text" class="form-control" id="fecha_egreso" name="fecha_egreso" value="<?php echo $fecha; ?>" disabled>
                            </div>
                        </div>
                    </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="saldoCC" class="col-sm-3 control-label" style="text-align:left;">Saldo</label>
                            <div class="col-sm-8">
