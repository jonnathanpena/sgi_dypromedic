                ...
                <form class="form-horizontal" method="post" id="guardar_proveedor" name="guardar_proveedor">
                    ...
                    <div class="form-group producto">
                        <div class="form-group">
                            <label for="ruc" class="col-sm-3 control-label"  style="text-align:left; margin-left: 2%;">RUC<span class="obligatorio">*</span></label>
                            <div class="col-sm-8">
                                <input style="width: 95%; margin-left: -8px;" type="number" class="form-control" id="ruc" name="ruc" min="1" step="1" onkeyup="consultarRUC()" placeholder="RUC" required>
                                <span style="color: red;" id="span_ruc">¡Proveedor ya registrado!</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="nombre" class="col-sm-3 control-label" style="text-align:left; margin-left: 2%;">Nombre<span class="obligatorio">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="Correo" class="col-sm-3 control-label" style="text-align:left;">Email</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="url" class="form-control"  value="http://" id="Pagweb" name="Pagweb" placeholder="http://www.pagweb.com">
                            </div>
                        </div>
                        <h4 style="text-align:left; ">Persona de Contacto</h4>                        
                        <div class="form-group">
                            <label for="nombre_contacto" class="col-sm-3 control-label" style="text-align:left;">Nombre</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nombre_contacto" name="nombre_contacto" placeholder="Nombre Contacto">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="telefono_contacto" class="col-sm-3 control-label" style="text-align:left;">Teléfono</label>
                            <div class="col-sm-8">
