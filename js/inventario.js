...
function generate_table() {
    ...
    $.each(displayRecords, function(index, row) {
        ...
        tr.append("<td class='text-left'>" + row.df_cant_bodega + "</td>");
        //tr.append("<td class='text-center'>" + row.df_cant_transito + "</td>");
        tr.append("<td class='text-left'>" + row.df_nombre_producto + "</td>");
        tr.append("<td class='text-left'>" + (row.df_ppp_ind).toFixed(2) + "</td>");
        tr.append("<td class='text-left'>" + (row.df_pvt_ind).toFixed(2) + "</td>");
        tr.append("<td class='text-left'>" + (row.cantidad * row.df_ppp_ind).toFixed(2) + "</td>");
        tr.append("<td class='text-left'>" + (row.cantidad * row.df_pvt_ind).toFixed(2) + "</td>");
