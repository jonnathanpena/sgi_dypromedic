...
$detalleRemision->df_valor_sin_iva_detrem= $info[0]["df_valor_sin_iva_detrem"];
$detalleRemision->df_iva_detrem= $info[0]["df_iva_detrem"];
$detalleRemision->df_valor_total_detrem= $info[0]["df_valor_total_detrem"];
$detalleRemision->df_id_detrem= $info[0]["df_id_detrem"];

// insert detalleRemision
$response = $detalleRemision->update();
if($response == true){
