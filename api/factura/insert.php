...
$factura->df_clave_acceso_fac= $info[0]["df_clave_acceso_fac"];
...
$factura->df_creadaBy= $info[0]["df_creadaBy"];
$factura->df_fecha_creacion= $info[0]["df_fecha_creacion"];
$factura->df_edo_factura_fac= $info[0]["df_edo_factura_fac"];
$factura->df_fecha_entrega_fac= $info[0]["df_fecha_entrega_fac"];


// insert factura
$response = $factura->insert();
if($response != false){
    $response = $response * 1;
