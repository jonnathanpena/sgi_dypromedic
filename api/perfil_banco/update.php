...
$perfilBanco->dp_fecha_modifica_per_ban= $info[0]["dp_fecha_modifica_per_ban"];
$perfilBanco->dp_modificadoby_per_ban= $info[0]["dp_modificadoby_per_ban"];
$perfilBanco->dp_id_perfil_ban= $info[0]["dp_id_perfil_ban"];


// insert perfilBanco
$response = $perfilBanco->update();
if($response == true){
